...
export const BUILDING_DEFS: Record<number, BuildingDef> = {
  ...
  [BuildingType.Hatchery]: {
    ...
    tileHeight: 3,
    supplyProvided: 10,
    produces: [UnitType.Drone, UnitType.Zergling, UnitType.Queen, UnitType.Overlord, UnitType.Roach, UnitType.Hydralisk, UnitType.Mutalisk, UnitType.Ravager, UnitType.Ultralisk, UnitType.Corruptor, UnitType.Viper, UnitType.Infestor],
    color: ZERG_COLOR,
    requires: null,
  },
  [BuildingType.SpawningPool]: {
    ...
    tileHeight: 2,
    supplyProvided: 0,
    produces: [UnitType.Zergling, UnitType.Baneling, UnitType.Lurker],
    color: 0x882222,
    requires: null,
  },
