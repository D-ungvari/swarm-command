...
export const BUILDING_DEFS: Record<number, BuildingDef> = {
  ...
  [BuildingType.Hatchery]: {
    ...
    tileHeight: 3,
    supplyProvided: 10,
    produces: [UnitType.Drone, UnitType.Overlord, UnitType.Zergling, UnitType.Queen, UnitType.Roach, UnitType.Hydralisk, UnitType.Mutalisk, UnitType.Corruptor, UnitType.Infestor, UnitType.Viper, UnitType.Ultralisk],
    color: ZERG_COLOR,
    requires: null,
  },
  [BuildingType.Lair]: {
