...
export const UNIT_DEFS: Record<number, UnitDef> = {
  ...
  [UnitType.Viking]: {
    ...
    name: 'Viking',
    faction: Faction.Terran,
    hp: 135, damage: 10, range: 9, speed: 3.85,
    attackCooldown: 1500, splashRadius: 0,
  ...
  [UnitType.Thor]: {
    ...
    name: 'Thor',
    faction: Faction.Terran,
    hp: 400, damage: 30, range: 7, speed: 2.62,
  ...
  [UnitType.Baneling]: {
    ...
    name: 'Baneling',
    faction: Faction.Zerg,
    hp: 30, damage: 16, range: 0.3, speed: 3.5,
  ...
  [UnitType.Hydralisk]: {
    ...
    name: 'Hydralisk',
    faction: Faction.Zerg,
    hp: 90, damage: 12, range: 5, speed: 2.8,
  ...
  [UnitType.Roach]: {
    ...
    name: 'Roach',
    faction: Faction.Zerg,
    hp: 145, damage: 16, range: 4, speed: 2.8,
