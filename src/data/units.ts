...
export const UNIT_DEFS: Record<number, UnitDef> = {
  ...
  [UnitType.Reaper]: {
    ...
    name: 'Reaper',
    faction: Faction.Terran,
    hp: 60, damage: 4, range: 5, speed: 5.25,
    attackCooldown: 1100, splashRadius: 0,
    width: 10, height: 10, color: 0x88aacc,
    costMinerals: 50, costGas: 50, buildTime: 22,
    damageType: DamageType.Normal, armorClass: ArmorClass.Light,
    isAir: 0, canTargetGround: 1, canTargetAir: 0,
  },
  [UnitType.Viking]: {
    ...
    name: 'Viking',
    faction: Faction.Terran,
    hp: 135, damage: 10, range: 9, speed: 3.0,
    attackCooldown: 1500, splashRadius: 0,
    width: 16, height: 14, color: 0x6699bb,
    costMinerals: 150, costGas: 75, buildTime: 30,
  ...
  [UnitType.WidowMine]: {
    ...
    name: 'Widow Mine',
    faction: Faction.Terran,
    hp: 90, damage: 125, range: 5, speed: 3.75,
  ...
  [UnitType.Cyclone]: {
    ...
    name: 'Cyclone',
    faction: Faction.Terran,
    hp: 120, damage: 18, range: 6, speed: 3.0,
    attackCooldown: 1000, splashRadius: 0,
    width: 14, height: 12, color: 0x335577,
    costMinerals: 150, costGas: 100, buildTime: 25,
    damageType: DamageType.Normal, armorClass: ArmorClass.Armored,
    isAir: 0, canTargetGround: 1, canTargetAir: 1,
  },
  [UnitType.Thor]: {
    ...
    name: 'Thor',
    faction: Faction.Terran,
    hp: 400, damage: 30, range: 7, speed: 1.5,
    attackCooldown: 3000, splashRadius: 0.5,
  ...
  [UnitType.Battlecruiser]: {
    ...
    name: 'Battlecruiser',
    faction: Faction.Terran,
    hp: 550, damage: 8, range: 6, speed: 1.875,
    attackCooldown: 250, splashRadius: 0,
    width: 32, height: 32, color: 0x334455,
    costMinerals: 400, costGas: 300, buildTime: 60,
    damageType: DamageType.Normal, armorClass: ArmorClass.Armored,
  ...
  [UnitType.Queen]: {
    ...
    name: 'Queen',
    faction: Faction.Zerg,
    hp: 175, damage: 9, range: 7, speed: 2.25,
    attackCooldown: 860, splashRadius: 0,
    width: 14, height: 14, color: 0xbb44bb,
    costMinerals: 150, costGas: 0, buildTime: 18,
    damageType: DamageType.Normal, armorClass: ArmorClass.Armored,
    isAir: 0, canTargetGround: 1, canTargetAir: 1,
  },
  [UnitType.Overlord]: {
    ...
    name: 'Overlord',
    faction: Faction.Zerg,
    hp: 200, damage: 0, range: 0, speed: 2.0,
    attackCooldown: 0, splashRadius: 0,
  ...
  [UnitType.Ravager]: {
    ...
    name: 'Ravager',
    faction: Faction.Zerg,
    hp: 120, damage: 16, range: 6, speed: 3.0,
    attackCooldown: 1800, splashRadius: 0,
    width: 16, height: 16, color: 0xcc4422,
    costMinerals: 25, costGas: 75, buildTime: 9,
    damageType: DamageType.Normal, armorClass: ArmorClass.Armored,
    isAir: 0, canTargetGround: 1, canTargetAir: 0,
  },
  [UnitType.Lurker]: {
    ...
    name: 'Lurker',
    faction: Faction.Zerg,
    hp: 200, damage: 20, range: 8, speed: 3.0,
    attackCooldown: 1500, splashRadius: 1.0,
  ...
  [UnitType.Infestor]: {
    ...
    name: 'Infestor',
    faction: Faction.Zerg,
    hp: 90, damage: 0, range: 0, speed: 2.25,
    attackCooldown: 0, splashRadius: 0,
    width: 12, height: 12, color: 0x446622,
    costMinerals: 150, costGas: 150, buildTime: 36,
    damageType: DamageType.Normal, armorClass: ArmorClass.Light,
  ...
  [UnitType.Ultralisk]: {
    ...
    name: 'Ultralisk',
    faction: Faction.Zerg,
    hp: 500, damage: 35, range: 1, speed: 2.25,
    attackCooldown: 670, splashRadius: 1.5,
    width: 34, height: 34, color: 0x332211,
    costMinerals: 300, costGas: 200, buildTime: 55,
    damageType: DamageType.Normal, armorClass: ArmorClass.Armored,
    isAir: 0, canTargetGround: 1, canTargetAir: 0,
  },
  [UnitType.Corruptor]: {
    ...
    name: 'Corruptor',
    faction: Faction.Zerg,
    hp: 200, damage: 14, range: 6, speed: 2.5,
  ...
  [UnitType.Viper]: {
    ...
    name: 'Viper',
    faction: Faction.Zerg,
    hp: 130, damage: 0, range: 0, speed: 3.75,
    attackCooldown: 0, splashRadius: 0,
    width: 14, height: 14, color: 0x669944,
    costMinerals: 200, costGas: 50, buildTime: 29,
    damageType: DamageType.Normal, armorClass: ArmorClass.Light,
    isAir: 1, canTargetGround: 0, canTargetAir: 0,
  },
};
